...
export const MainBoxStyle = styled(
  ...
  borderTop: `0.208vw solid ${theme?.palette?.neuPalette?.hexTwo}`,
  borderBottom: `0.208vw solid ${theme?.palette?.neuPalette?.hexTwo}`,
  borderLeft: $isMobile
    ? `0.104vw solid ${theme?.palette?.neuPalette?.hexTwo}`
    : `none`,
