...
const Title = (props: any) => {
  ...
  const centerMultiRowVariant =
    props?.alignmentVariant == "center-with-multi-line-title"
  const regularOneRowTitle =
    props?.alignmentVariant == "regular-with-one-row-title"
  const regularTwoRowTitle =
    props?.alignmentVariant == "regular-with-two-row-title"
  const subTitleLength = props?.charactersLimit ?? 300

  const isLogin = props?.largeVariant === "authentication.group.grey-grid"
  const isThemeTitle =
    props?.largeVariant === "ihcl.core.group.group-with-stepper-and-tabs"
      ...
      {(props?.title || props?.subTitle || props?.heading) && (
        <Box
          sx={{
            display: "flex",
            justifyContent:
              regularOneRowTitle || regularTwoRowTitle
                ? "flex-start"
                : "center",
            marginBottom: isMobile
              ...
              : isLogin
              ? "1.04vw"
              : props?.titleBottomGap ?? "4.17vw",
            padding: isMobile
              ? "0vw"
              : props?.isComponentFullWidth
              ? "0vw 12.5vw"
              : "0vw",
            flexDirection: isMobile
              ...
              : "row",
            gap: "1.5%",
            alignItems: regularOneRowTitle
              ? "center"
              : regularTwoRowTitle
              ? "flex-end"
              : "",
            marginLeft:
              regularOneRowTitle || regularTwoRowTitle || centerVariant
                ? isMobile
                  ? "13.1vw"
                  : ""
                : "",
          ...
          <Box
            sx={{
              flex: "0 0 50%",
              alignSelf:
                isMobile && (regularOneRowTitle || regularTwoRowTitle)
                  ? "self-start"
                  : "",
            }}>
                  ...
                  <>
                    ...
                    <Box>
                      <Typography
                        ...
                        sx={{
                          display: "flex",
                          whiteSpace: centerMultiRowVariant
                            ? "initial"
                            : "nowrap",
            ...
            <Box
              sx={{
                ...
                maxWidth: isMobile
                  ...
                  ? DesktopPxToVw(840)
                  : DesktopPxToVw(673),
                height: props?.action?.[0]?.primaryAction?.[0]?.title
                  ? "90%"
                  : "auto",
                justifyContent: props?.action?.[0]?.primaryAction?.[0]?.title
                  ? "space-between"
                  : "",
                alignSelf: props?.action?.[0]?.primaryAction?.[0]?.title
                  ? "flex-start"
                  : "flex-end",
                textAlign: "center",
              ...
              {props?.primaryAction?.title && (
                <Box mb={1}>
                  <RenderActionItem
                    ...
                    isActionButtonType={
                      props?.primaryAction?.variant === "link" ? false : true
                    }
                  />
                </Box>
              )}
